...
function ChatPanel({
 ...
 const deleteMessage = async (messageId) => {
  ...
  if (!activeChat) {
    return (
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f0f2f5', borderRadius: '12px', margin: '1rem' }}>
  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', height: '95%', backgroundColor: '#fff', borderRadius: '12px', margin: '1rem', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.05)', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        <div style={{ flex: 1, overflowY: 'auto', padding: '1rem', backgroundColor: '#f9f9f9' }}>
          <MessageList
            ...
            onDelete={deleteMessage} // ✅ pass to child
          />
          {isTyping && (
